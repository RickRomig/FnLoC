...
Modified the un-install script verbosity to the rm commands.
...
In main(), renamed some of the counting variables to be more meaninful.
...
Re-entered the orginal FnLoC code and compiled with GCC on Linux Mint 18.3.
